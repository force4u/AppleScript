...
#	set ocidBoolValue to (refMe's NSNumber's numberWithBool:false) --OFFの場合はこちら
set ocidBoolValue to (refMe's NSNumber's numberWithBool:true)
ocidPropertiesDictM's setValue:(ocidBoolValue) forKey:("com.apple.finder.showcloudservices")
##【６】にキーと値を入れる　NetworkBrowser.bonjourEnabled
#	set ocidBoolValue to (refMe's NSNumber's numberWithBool:false) --OFFの場合はこちら
set ocidBoolValue to (refMe's NSNumber's numberWithBool:true)
...
#	set ocidBoolValue to (refMe's NSNumber's numberWithBool:false) --OFFの場合はこちら
set ocidBoolValue to (refMe's NSNumber's numberWithBool:true)
ocidPropertiesDictM's setValue:(ocidBoolValue) forKey:("com.apple.LSSharedFileList.FavoriteVolumes.ShowHardDrives")
##【６】にキーと値を入れる　NetworkBrowser.bonjourEnabled
#	set ocidBoolValue to (refMe's NSNumber's numberWithBool:false) --OFFの場合はこちら
set ocidBoolValue to (refMe's NSNumber's numberWithBool:true)
ocidPropertiesDictM's setValue:(ocidBoolValue) forKey:("com.apple.LSSharedFileList.FavoriteVolumes.ShowEjectableVolumes")
##【６】にキーと値を入れる　NetworkBrowser.bonjourEnabled
#	set ocidBoolValue to (refMe's NSNumber's numberWithBool:false) --OFFの場合はこちら
set ocidBoolValue to (refMe's NSNumber's numberWithBool:true)
ocidPropertiesDictM's setValue:(ocidBoolValue) forKey:("com.apple.LSSharedFileList.FavoriteVolumes.ComputerIsVisible")
