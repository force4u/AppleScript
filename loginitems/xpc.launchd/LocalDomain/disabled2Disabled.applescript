...
#
#	要管理者権限
# 	com.apple.xpc.launchdのdisabledの値をtrue=停止に変更します
#	
...
##ファイル名　loginitems
set strPlistFileName to ("disabled.plist") as text
##パス
...
repeat with itemResponse in listResponse
	...
	(ocidPlistDict's setValue:(refMe's NSNumber's numberWithBool:true) forKey:(strItemKey))
