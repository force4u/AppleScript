...
set strLpoptionsPath to (ocidFilePathURL's |path|()) as text
...
##ブランクにして
set strCommandText to ("/bin/echo -n >  \"" & strLpoptionsPath & "\"") as text
do shell script strCommandText
##書き換える
set strCommandText to ("/bin/echo \"Default " & strDeviceName & "\" >  \"" & strLpoptionsPath & "\"") as text
do shell script strCommandText
