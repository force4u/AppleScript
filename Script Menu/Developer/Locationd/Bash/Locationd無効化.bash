...
STR_PLIST_PATH="$STR_DIR_PATH$STR_FILE_NAME"
/bin/echo "PLISTファイルパス：$STR_PLIST_PATH"
STR_RESPONSE=$(/usr/bin/sudo -u _locationd /usr/bin/defaults write "$STR_PLIST_PATH" LocationServicesEnabled -boolean false)
/bin/echo "/usr/bin/sudo -u _locationd  /usr/bin/defaults write $STR_PLIST_PATH LocationServicesEnabled -boolean false"
/bin/echo "↑ 実行したコマンド ↓ 結果"
