...
set strHTML to (strHTML & "<thead title=\"項目名称\"><tr><th title=\"代表的な呼称\" scope=\"row\" >代表的な呼称</th><th title=\"Aspect Ratio\">縦横比</th><th title=\"横\" scope=\"col\">横</th><th title=\"縦\"  scope=\"col\">縦</th></tr></thead><tbody title=\"縦横比の表\" >") as text
##############################
#####計算部
##############################
...
repeat with itemAllKeys in ocidAllKeys
	...
	set strHTML to (strHTML & "<tr><th title=\"代表的な呼称\"  scope=\"row\">" & strAllKeys & "</th><td title=\"Aspect Ratio\">" & strAspectRatio & "</td><td title=\"横\">" & numRealW & "</td><td title=\"縦\">" & strResponse & "</td></tr>") as text
end repeat
