...
set strTitle to ("３桁８進数を入力") as text

set strMes to "３桁８進数を入力\n777-->511\n775-->509\n770-->504\n755-->493\n750-->488\n700-->448\n555-->365\n333-->219"
...
set strOctalText to strResponse as text
...
###
set numRaw to numDecimal as text
set strMes to ("計算結果です\r８進: " & strResponse & "→１０進: " & numRaw & "\r") as text
