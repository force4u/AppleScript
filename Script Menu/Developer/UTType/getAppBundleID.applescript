...
set recordResult to (display dialog "bundle identifier 戻り値です" with title "bundle identifier" default answer strBunndleID buttons {"クリップボードにコピー", "キャンセル", "OK"} default button "OK" giving up after 20 with icon aliasIconPath without hidden answer)
