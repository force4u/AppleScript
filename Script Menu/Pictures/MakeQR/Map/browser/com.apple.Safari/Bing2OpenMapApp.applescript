...
###アプリケーションのバンドルID
set strBundleID to "com.apple.Safari"
###エラー処理
...
## MapAppで開くURL
set strChl to ("maps://maps.apple.com/?q=" & (ocidLatitude as text) & "," & (ocidLongitude as text) & "," & (ocidAltitude as text) & "z") as text
