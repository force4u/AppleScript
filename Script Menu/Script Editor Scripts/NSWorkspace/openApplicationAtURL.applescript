...
set strInsertScript to ("set appSharedWorkspace to refMe's NSWorkspace's sharedWorkspace()
...
(appSharedWorkspace's \r:(ocidAppPathXXXXXXXX) configuration:(ocidConfig) completionHandler:(missing value))") as text
