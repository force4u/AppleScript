...
set strInsertScript to ("set appFileManager to refMe's NSFileManager's defaultManager()\rset ListDone to (appFileManager's moveItemAtPath:(XXXXXXX) toPath:(XXXXXX) |error|:(reference))\r") as text
