...
set strInsertScript to ("set appFileManager to refMe's NSFileManager's defaultManager()\rset ListDone to (appFileManager's trashItemAtURL:(itemCachesDirPathURL) resultingItemURL:(itemCachesDirPathURL) |error|:(reference))\r") as text
