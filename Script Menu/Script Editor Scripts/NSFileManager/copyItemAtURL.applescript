...
set strInsertScript to ("set appFileManager to refMe's NSFileManager's defaultManager()\rset ListDone to (appFileManager's copyItemAtURL:(XXXXXXX) toURL:(XXXXXX) |error|:(reference))\r") as text
