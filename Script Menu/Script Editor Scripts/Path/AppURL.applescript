...
set strInsertScript to ("set strBundleID to \"com.apple.finder\"\rset ocidAppBundle to (refMe's NSBundle's bundleWithIdentifier:(strBundleID))\rset ocidAppPathURL to ocidAppBundle's bundleURL()") as text
