...
set strInsertScript to "set strText to \"AAA,BBB,CCC,DDD\"\rset ocid_Strings to refMe's NSString's stringWithString:(strText)\rset ocidSome_Array to ocid_Strings's componentsSeparatedByString:(\",\")" as text
