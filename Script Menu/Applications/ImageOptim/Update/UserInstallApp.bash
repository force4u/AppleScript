...
###ダウンロードURL
STR_URL="https://imageoptim.com/ImageOptim.tbz2"
###ファイル名を取得
...
function DO_MOVE_TO_TRASH() {
	if [ -e "$1" ]; then
		TRASH_DIR=$(/usr/bin/mktemp -d "/Users/$CURRENT_USER/.Trash/ImageOptim.XXXXXXXX")
		/bin/chmod 777 "$TRASH_DIR"
		/bin/mv "$1" "$TRASH_DIR"
	fi
}
DO_MOVE_TO_TRASH "/Applications/ImageOptim.app"
DO_MOVE_TO_TRASH "/Users/$CURRENT_USER/Applications/ImageOptim.app"
DO_MOVE_TO_TRASH "/Users/$CURRENT_USER/Applications/Pictures/ImageOptim.app"
...
####移動
/usr/bin/ditto "$USER_TEMP_DIR/ImageOptim/ImageOptim.app" "/Users/$CURRENT_USER/Applications/Pictures/ImageOptim.app"
####終了
/bin/echo "インストール終了:" "$CURRENT_USER"
###場所　必要なら
#	open "/Users/$CURRENT_USER/Applications/Pictures"
exit 0
