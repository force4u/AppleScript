...
set strHtmlLink to ("<div><a href=\"" & strURL & "\" target=\"_blank\" lang=\"en\" title=\"リンクを新しいウィンドで開きます\">" & strTITLE & "</a><a href=\"" & strQrCodeURL & "\" target=\"_blank\" lang=\"en\" title=\"リンクのQRバーコードを新しいウィンドで開きます\">[QR]</a></div>") as text
...
set strDefaultAnswer to strHtmlLink as text
try
