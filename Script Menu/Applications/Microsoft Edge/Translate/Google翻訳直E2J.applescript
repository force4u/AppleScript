...
####翻訳ページURL
set strTranslateURL to "https://translate.google.com/?sl=auto&tl=ja&text=" & strURL & "&op=translate" as text
set strTranslateURL to "https://translate.google.com/translate?sl=auto&tl=ja&hl=ja&u=" & strURL & "&client=webapp" as text
log strTranslateURL
###OPEN
tell application "Microsoft Edge"
	activate
