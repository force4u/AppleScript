...
################################################
### クリーニング
### 処理開始前に古いログを起動時に削除するようにしておく
/bin/mkdir -p "/private/tmp/Cleanup At Startup"
USER_TRASH_DIR=$(/usr/bin/mktemp -d "/private/tmp/Cleanup At Startup/o365.XXXXXXXX")
/bin/chmod 777 "$USER_TRASH_DIR"
/bin/mv "/Library/Logs/Microsoft" "$USER_TRASH_DIR"
...
/usr/sbin/installer -pkg "$LOCAL_TMP_DIR/$PKG_FILE_NAME" -target / -dumplog -allowUntrusted -lang ja
	/bin/echo "インストールDone:	" "$PKG_FILE_NAME"
################################################
### クリーニング　ユーザードメイン
...
for ITEM_LIST in "${LIST_USER[@]}"; do
	...
	#####
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Application Scripts/com.microsoft.autoupdate2" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Application Scripts/com.microsoft.Excel" "${ITEM_LIST}" 
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Application Scripts/com.microsoft.Powerpoint" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Application Scripts/com.microsoft.Word" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Application Scripts/com.microsoft.teams" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/com.microsoft.autoupdate2" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/com.microsoft.Word" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/com.microsoft.Powerpoint" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/com.microsoft.Excel" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/com.microsoft.teams" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/HTTPStorages/com.microsoft.autoupdate2" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/HTTPStorages/com.microsoft.Word" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/HTTPStorages/com.microsoft.Powerpoint" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/HTTPStorages/com.microsoft.Excel" "${ITEM_LIST}"
	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/HTTPStorages/com.microsoft.teams" "${ITEM_LIST}"

	DO_MOVE_TO_TRASH_USER "/Users/${ITEM_LIST}/Library/Caches/Microsoft" "${ITEM_LIST}"
done
	/bin/echo "処理終了"
exit 0
