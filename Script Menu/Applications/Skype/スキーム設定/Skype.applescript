...
###設定項目 URLスキーム
set strScheme to "skype://" as text
###NSURL
...
################################
set appShardWorkspace to refMe's NSWorkspace's sharedWorkspace()
appShardWorkspace's setDefaultApplicationAtURL:(ocidAppPathURL) toOpenURLsWithScheme:("skype") completionHandler:(missing value)
