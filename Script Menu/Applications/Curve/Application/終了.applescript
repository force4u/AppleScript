...
###ヘルパーのバンドルID
set listHelperBundleID to {"com.vladidanila.vectornator", "com.linearity.vn", "iCloud.com.linearity.vn", "com.linearity.vn.home.show", "com.linearity.vn.document.edit", "com.linearity.vn.document.new", "com.linearity.vn.Thumbnails", "com.vectornator.item.layer", "com.vectornator.item.element"} as list
############################
###　本処理 
############################
