...
set strReadPasteboardTypeString to ocidReadPasteboardTypeString as text

################################
######%エンコードする
################################
set ocidContents to refMe's NSString's stringWithString:(strReadPasteboardTypeString)
########   %エンコードする
##キャラクタセットを指定
