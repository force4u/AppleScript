...
###アプリケーションのバンドルID
set strBundleID to "com.adobe.acc.AdobeCreativeCloud"
...
set ocidSaveDirPathURL to ocidLibraryDirURL's URLByAppendingPathComponent:("Scripts/Applications/Creative Cloud/Open")
##フォルダ作る
...
set strFilePath to "~/Library/Scripts/Applications/Creative Cloud/Webloc/com.microsoft.edgemac.ManagedFavorites.mobileconfig"
...
set ocidChildrenArray to ocidPlistDict's valueForKey:("children")
repeat with itemChildrenArray in ocidChildrenArray
	...
	################################
	##設定項目
	set strFileName to (itemChildrenArray's valueForKey:("name")) as text
	set strURL to (itemChildrenArray's valueForKey:("url")) as text
	#########################
	##WEBLOC　内容
