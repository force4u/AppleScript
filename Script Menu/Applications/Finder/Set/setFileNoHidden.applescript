...
set aliasFilePath to (choose file strMesText default location aliasDesktopDirPath with prompt strPromptText of type listUTI with invisibles without multiple selections allowed and showing package contents) as alias
try
