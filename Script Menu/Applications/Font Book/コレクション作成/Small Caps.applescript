...
####設定項目
set strTraitsName to ("SmallCaps") as text
set ocidTraits to (refMe's NSSmallCapsFontMask)
####スタイルリスト
set listFontFace to {"Small Caps", "SmallCaps", "SC", "SmCaps", "SCaps"} as list
#Arrayにしておく
set ocidFontFaceArray to refMe's NSArray's alloc()'s initWithArray:(listFontFace)
####曖昧比較用リスト
set listFontFaceAmb to {"Small Caps", "SmallCaps", "SmCaps", "SCaps"} as list
