...
####設定項目
set strTraitsName to ("Italic") as text
set ocidTraits to (refMe's NSItalicFontMask)
####スタイルリスト
set listFontFace to {"Italic", "Oblique", "Obl", "Ita", "Ital", "IT", "Ob", "Kursiv", "Schräg","Inclined"} as list
#Arrayにしておく
set ocidFontFaceArray to refMe's NSArray's alloc()'s initWithArray:(listFontFace)
####曖昧比較用リスト
set listFontFaceAmb to {"Italic", "Oblique", "Obl", "Ita"} as list
...
####
set strSetUnTraitsName to ("Unitalic") as text
