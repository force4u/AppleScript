...
set listBundleID to {"com.facebook.archon", "com.facebook.archon.maintenance", "com.facebook.archon.loginhelper"} as list
...
set strCommandText to ("/bin/ps -alx  | /usr/bin/grep \"MessengerHelper\" | /usr/bin/grep -v grep|  /usr/bin/awk -F' ' '{print $2}'") as text
