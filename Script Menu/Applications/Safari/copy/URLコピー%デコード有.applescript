...
##############
set strURL to urlEncode(argText)
##############
...
set recordResult to (display dialog "前面WEBページ戻り値です" with title "bundle identifier" default answer strURL buttons {"クリップボードにコピー", "キャンセル", "OK"} default button "OK" giving up after 20 with icon aliasIconPath without hidden answer)
