...
######PLISTパス
#####################################
set ocidFilePathURL to ocidSaveDirPathURL's URLByAppendingPathComponent:"SPSoftwareDataType.json"
...
######コマンド実行
#####################################
set strCommandText to "/usr/sbin/system_profiler  SPSoftwareDataType -json"
...
set ocidDataTypeArray to (ocidJsonRootDict's objectForKey:("SPSoftwareDataType"))
set ocidJsonDict to ocidDataTypeArray's firstObject()
...
repeat with itemAllKeys in ocidAllKeys
	...
	set strValue to (ocidJsonDict's valueForKey:(itemAllKeys)) as text
...
###ダイアログ
set recordResult to (display dialog " 戻り値です\rコピーしてメールかメッセージを送ってください" with title "SPSoftwareDataType" default answer strOutPutText buttons {"クリップボードにコピー", "キャンセル", "OK"} default button "OK" giving up after 30 with icon aliasIconPath without hidden answer)
###クリップボードコピー
