...
-codec:a  aac  -ar 32K -ab 128k
	*)
	...
	set strCommandText to ("\"" & strPathToFFMPEG & "\" -i '" & strFilePath & "'   -codec:v  libx264 -profile:v baseline  -vf \"scale=1280:-1\"  -tune film  -crf 28 -codec:a  aac  -ar 48K -ab 128k '" & strSaveFilePath & "'") as text
