...
to do16bitDec2Hex(listDec16bitRGB)
	...
	set ocid8Bit2HexDict to refMe's NSMutableDictionary's alloc()'s init()
	ocid8Bit2HexDict's setDictionary:(record8Bit2Hex)
	set strHexValue to ("") as text
	repeat with item16BitDec in listDec16bitRGB
		set num8BitDec to ((item16BitDec / 65535) * 255) as integer
		set str8BitDec to num8BitDec as text
		set ocidValue to (ocid8Bit2HexDict's valueForKey:(str8BitDec))
		set strHexValue to (strHexValue & ocidValue) as text
	end repeat
