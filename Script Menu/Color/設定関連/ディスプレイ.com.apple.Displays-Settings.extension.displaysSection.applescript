...
###パネルIDをパスにセット
ocidURLComponents's setPath:("com.apple.Displays-Settings.extension")
###アンカーをクエリーとして追加
ocidURLComponents's setQuery:("displaysSection")
...
reveal anchor "displaysSection" of pane id "com.apple.Displays-Settings.extension"
end tell
tell application id "com.apple.finder"
open location "x-apple.systempreferences:com.apple.Displays-Settings.extension?displaysSection"
end tell
tell application id "com.apple.systempreferences" to activate
end if
return
