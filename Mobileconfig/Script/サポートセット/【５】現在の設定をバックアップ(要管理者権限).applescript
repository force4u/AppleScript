...
##
set strSaveFileName to (strDateNo & ".all.plist") as text
##
...
##コマンド整形
set strCommandText to ("/usr/bin/sudo /usr/bin/profiles show -all " & strUserName & " -type configuration -output \"" & strSaveFilePath & "\"") as text
###実行
