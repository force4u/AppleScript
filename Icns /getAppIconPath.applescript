...
set strMesText to "Iconのパスとbundle identifierを取得します" as text
...
set strMes to ("bundle identifier 戻り値です\rBundle ID\r" & strBunndleID) as text

set recordResult to (display dialog strMes with title "bundle identifier" default answer strIconPath buttons {"クリップボードにコピー", "キャンセル", "OK"} default button "OK" giving up after 20 with icon aliasIconPath without hidden answer)
